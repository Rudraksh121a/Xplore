...
export default function NewTripScreen({ navigation }: { navigation: any }) {
  ...
  const [tripType, setTripType] = useState("Solo"); // Default trip type

  const budgetOptions = [
    { label: "💰 Budget-Friendly (₹5k - ₹20k)", value: "Budget-Friendly" },
    { label: "💼 Mid-Range (₹20k - ₹50k)", value: "Mid-Range" },
    { label: "🏨 Luxury (₹50k - ₹1L)", value: "Luxury" },
    { label: "🌟 Ultra-Luxury (₹1L+)", value: "Ultra-Luxury" },
